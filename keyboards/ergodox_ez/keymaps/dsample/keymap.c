  ...
  [2] = LAYOUT_ergodox(
       ...
       HSV_240_255_255,KC_TRANSPARENT,KC_TRANSPARENT,LGUI(KC_KP_0),KC_TRANSPARENT,
                                            KC_TRANSPARENT,  RGB_TOG,
                                                             RGB_VAI,
                                  KC_TRANSPARENT,KC_TRANSPARENT,RGB_VAD,

       KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LCTL(LSFT(KC_POWER)),KC_TRANSPARENT,
       TO(3),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LCTL(LGUI(KC_SPACE)),
                KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
       TO(0),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_AUDIO_MUTE,KC_TRANSPARENT,KC_TRANSPARENT,RGB_HUD,RGB_HUI,RGB_MOD,RGB_SLD,KC_MEDIA_STOP,KC_MEDIA_PLAY_PAUSE),
  // TXBOLT
  [3] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       TO(0),    STN_ST4, STN_RR,  STN_BR,  STN_GR,  STN_SR,  STN_ZR,
                          KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
       KC_NO,   KC_NO,
       KC_NO,
       KC_NO,   STN_E,   STN_U
