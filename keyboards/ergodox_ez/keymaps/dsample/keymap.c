...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(KC_ESCAPE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LEFT,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(1),KC_BSPACE,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_HYPR,KC_LCTRL,KC_LALT,KC_LGUI,KC_LEFT,KC_RIGHT,MO(2),KC_LALT,KC_LCTRL,KC_ENTER,KC_TAB,KC_LGUI,KC_RIGHT,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,TG(2),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,KC_SCOLON,KC_QUOTE,KC_MEH,KC_N,KC_M,KC_COMMA,KC_DOT,KC_KP_SLASH,KC_RSHIFT,KC_UP,KC_DOWN,KC_LBRACKET,KC_RBRACKET,MO(1),KC_HOME,KC_END,KC_PGUP,KC_PGDOWN,KC_BSPACE,KC_SPACE),
